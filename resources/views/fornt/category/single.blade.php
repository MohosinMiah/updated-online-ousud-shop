    ...
    <div class="row">
        ...
        <div class="col-md-9 col-md-push-3  col-main">
                   ...
                   <div class="category-view">
                            <div class="owl-carousel " 
                                ...
                                foreach ($allcategories as $allcategorie) {
                                    ?>
                                <div class="item " >
                                   <a href="/category/{{str_slug($allcategorie->title)}}"><img src="/images/{{$allcategorie->image}}" alt="category-images" width="500" height="250"></a>
                                </div>
                                   <?php 
                                } ?>
                            </div>
            ...
            <ul class="category-links">
               ...
               <?php 
                $cat_title = $title;
                $cat_title = str_replace('-', ' ', $title);
                $cat_id = 0;
                $allcategories = DB::table('categories')->where('title', $cat_title)->get();
                foreach ($allcategories as $allcategorie) {
                    $cat_id = $allcategorie->id;
                    ?>
                <li  class="current-cate"><a href="/category/{{str_slug($allcategorie->title)}}">{{$allcategorie->title}}</a></li>
...
<!-- Search By Alphabet ******************************************** -->
            ...
            <div class="products  products-grid">
                <ol class="product-items row">
                    ...
                    $allproducs = DB::table('tproducts')->where('cat_id', $cat_id)->paginate(20);
